...
urlpatterns = [
    ...
    path("amount-transfer-process/<account_number>/",transfer.process_amount_transfer,name="amount-transfer-process"),
   ...
   # Transactions
    ...
    path("delete-request.html/<account_number>/<transaction_id>",payment_request.DeletePaymentRequest,name="delete-request"),
